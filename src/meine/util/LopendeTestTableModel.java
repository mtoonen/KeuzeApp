 ...
 * @author Meine Toonen
 */
public class LopendeTestTableModel extends AbstractTableModel {

    String[] columnNames;
    Object[][] data;

    public LopendeTestTableModel() {
    ...
    public LopendeTestTableModel(String[] columnNames, Object[][] data) {
        this.columnNames = columnNames;
        this.data = data;
    }

    public LopendeTestTableModel(List<LopendeTest> data) {
        if (!data.isEmpty()) {
            this.data = new Object[data.size()][6];
